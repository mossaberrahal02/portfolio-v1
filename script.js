...
window.addEventListener('scroll', function() {
    ...
    if (window.scrollY > 50) {
        navbar.style.background = 'rgba(9, 9, 11, 0.98)';
        navbar.style.borderBottom = '1px solid #3f3f46';
    } else {
...
function revealOnScroll() {
    const reveals = document.querySelectorAll('.section-title, .about-text, .contact-text');
...
const throttledActiveLink = throttle(function() {
    const sections = document.querySelectorAll('section[id]');
    const navLinks = document.querySelectorAll('.nav-link');
...
// Replace the original scroll event listeners with throttled versions
